...
QT_MOC_LITERAL(1, 8, 11), // "render_page"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 11), // "std::string"
QT_MOC_LITERAL(4, 33, 2) // "go"

    },
    "Browser\0render_page\0\0std::string\0go"
};
...
void Browser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->render_page((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        case 1: _t->go(); break;
        default: ;
        }
        ...
        {
            using _t = void (Browser::*)(std::string );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Browser::render_page)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Browser::render_page(std::string _t1)
{
